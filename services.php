...
<!-- Mirrored from thewebmax.com/spa/services-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Aug 2022 10:12:15 GMT -->
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Spa Template | Services-2</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-box bg-white">
                                    ...
                                    <div class="wt-info p-a30 bg-gray">
                                        <h4 class="wt-title m-t0"><a href="javascript:void(0);">Back Massage</a></h4>
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-box bg-white">
                                    ...
                                    <div class="wt-info p-a30 bg-gray">
                                        <h4 class="wt-title m-t0"><a href="javascript:void(0);">Head Massage </a></h4>
                                        <p>Lorem ipsum dolor consectetur adipiscing Fusce varius euismod lacus eget feugiat rorem ipsum dolor consectetur Fusce varius . </p>
                                        <a href="javascript:void(0);" class="site-button ">More <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-box bg-white">
                                    ...
                                    <div class="wt-info p-a30 bg-gray">
                                        <h4 class="wt-title m-t0"><a href="javascript:void(0);">Body Scrub</a></h4>
                                        <p>Lorem ipsum dolor consectetur adipiscing Fusce varius euismod lacus eget feugiat rorem ipsum dolor consectetur Fusce varius . </p>
                                        <a href="javascript:void(0);" class="site-button ">More <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-box bg-white">
                                    ...
                                    <div class="wt-info p-a30 bg-gray">
                                        <h4 class="wt-title m-t0"><a href="javascript:void(0);">Aromatherapy Massage</a></h4>
                                        <p>Lorem ipsum dolor consectetur adipiscing Fusce varius euismod lacus eget feugiat rorem ipsum dolor consectetur Fusce varius . </p>
                                        <a href="javascript:void(0);" class="site-button ">More <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-box bg-white">
                                    ...
                                    <div class="wt-info p-a30 bg-gray">
                                        <h4 class="wt-title m-t0"><a href="javascript:void(0);">Massages & Body</a></h4>
                                        <p>Lorem ipsum dolor consectetur adipiscing Fusce varius euismod lacus eget feugiat rorem ipsum dolor consectetur Fusce varius . </p>
                                        <a href="javascript:void(0);" class="site-button ">More <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-box bg-white">
                                    ...
                                    <div class="wt-info p-a30 bg-gray">
                                        <h4 class="wt-title m-t0"><a href="javascript:void(0);">Beauty Spa</a></h4>
                                        <p>Lorem ipsum dolor consectetur adipiscing Fusce varius euismod lacus eget feugiat rorem ipsum dolor consectetur Fusce varius . </p>
                                        <a href="javascript:void(0);" class="site-button ">More <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="wt-box bg-white">
                                ...
                                <div class="wt-info p-a30 bg-gray">
                                    <h4 class="wt-title m-t0"><a href="javascript:void(0);">Facial Spa</a></h4>
                                    <p>Lorem ipsum dolor consectetur adipiscing Fusce varius euismod lacus eget feugiat rorem ipsum dolor consectetur Fusce varius . </p>
                                    <a href="javascript:void(0);" class="site-button  ">More <i class="fa fa-angle-double-right"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-box bg-white">
                                    ...
                                    <div class="wt-info p-a30 bg-gray">
                                        <h4 class="wt-title m-t0"><a href="javascript:void(0);">Hair Makeup</a></h4>
                                        <p>Lorem ipsum dolor consectetur adipiscing Fusce varius euismod lacus eget feugiat rorem ipsum dolor consectetur Fusce varius . </p>
                                        <a href="javascript:void(0);" class="site-button ">More <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
...
<!-- Mirrored from thewebmax.com/spa/services-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Aug 2022 10:12:17 GMT -->
</html>
